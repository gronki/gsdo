#!/bin/csh -f
############################################################
# created via WWW at Mon Apr 27 01:20:30 2026
############################################################
setenv SSW /opt/ssw
setenv ssw_host sohoftp.nascom.nasa.gov
setenv ssw_sw_host sohoftp.nascom.nasa.gov
setenv ssw_tar_old_style ""
setenv ssw_sw_sets "ssw_ssw_site ssw_packages_binaries ssw_sdo_aia ssw_sdo_gen ssw_ssw_gen ssw_vobs_gen ssw_vobs_ontology"
setenv ssw_db_sets ""
...
echo;echo ssw_sdo_aia.tar.Z;curl  -O https://soho.nascom.nasa.gov/solarsoft/offline/swmaint/tar/ssw_sdo_aia.tar.Z
echo;echo ssw_sdo_gen.tar.Z;curl  -O https://soho.nascom.nasa.gov/solarsoft/offline/swmaint/tar/ssw_sdo_gen.tar.Z
